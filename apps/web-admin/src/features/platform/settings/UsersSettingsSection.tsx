...
import { getRoleLabel } from '@/features/platform/config/modules';
...
function roleBadgeClass(role: UserRole) {
  ...
  if (role === 'Operador' || role === 'Gerente_Operaciones') {
    return 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300';
  }
  if (role === 'Encargado_Futbol') {
...
function UserForm({
  ...
  const [form, setForm] = useState<AppUser>(initial || { id: '', name: '', role: 'Gerente_Operaciones' });
