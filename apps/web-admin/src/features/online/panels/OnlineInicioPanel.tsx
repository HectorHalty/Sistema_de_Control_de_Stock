...
import { OnlineError, OnlinePanelShell, onlineCardClass, useOnlineOverview } from '../online-shared';
...
export function OnlineInicioPanel() {
  ...
  if (loading)
    return (
      <OnlinePanelShell title="Ventas online" subtitle="Estado general de las ventas por la web">
        Cargando...
      </OnlinePanelShell>
    );
  if (error)
  ...
  return (
    <OnlinePanelShell title="Ventas online" subtitle="Estado general de las ventas por la web">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((c) => (
          <div key={c.label} className={onlineCardClass('p-4')}>
